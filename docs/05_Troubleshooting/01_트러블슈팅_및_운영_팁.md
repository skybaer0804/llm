...
- **Git 체크포인트 활용 (중요)**: Claude Code나 AutoGen 에이전트가 작업 중 사용량 제한이나 에러로 멈췄을 때, 수시로 `git commit`을 해두었다면 작업 내용을 잃지 않고 해당 지점부터 재개할 수 있습니다. 자세한 내용은 **[Git 관리 가이드](../01_Setup/06_Git_관리_및_워크플로우_가이드.md)**를 참고하세요.
